 ...
 * Date: 11/14/2021
 * Description: This is the Contact Service class, this class builds a list (in memory) of contacts
...
public class ContactService {
	//Contact service has one field that is a vector of contacts that is initiated 
	...
	public void updateFirstName(String contactID, String firstName) {
		...
		//else throws an exception. Relies on Contact Class for validation.
	...
	public void updateLastName(String contactID, String lastName) {
		...
		//otherwise throws exceptions. Dependent on Contact validation.
		Contact updateContact = search(contactID);
		if(updateContact != null) {
	...
	public void updateNumber(String contactID, String Number) {
		...
		//otherwise throws an exception. Dependent on Contact validation
		Contact updateContact = search(contactID);
		if(updateContact != null) {
